...
var Button = function (_a) {
    var label = _a.label, _b = _a.rounded, rounded = _b === void 0 ? false : _b; _a.background; var props = __rest(_a, ["label", "rounded", "background"]);
    return (React.createElement(ButtonComponent, __assign({ rounded: rounded }, props), label));
};
var ButtonComponent = qe.button(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  background: ", ";\n  border-radius: ", ";\n  padding: 10px;\n"], ["\n  background: ", ";\n  border-radius: ", ";\n  padding: 10px;\n"])), function (_a) {
    var background = _a.background;
    return background && background;
}, function (props) { return props.rounded && "10px"; });
